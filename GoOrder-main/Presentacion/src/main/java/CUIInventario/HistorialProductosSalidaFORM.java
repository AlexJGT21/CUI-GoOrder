 ...
 * @author 
 */
public class HistorialProductosSalidaFORM extends javax.swing.JFrame {

    private final ColorBoton colorB;
    private final ColorBoton colorR;
    private final ColorBoton colorE;
    private final Control control;
    private DefaultTableModel salidaProductos;
    
    public HistorialProductosSalidaFORM(Control control) throws NegocioException {
        initComponents();
        setResizable(false);
        ...
        String[] columnas = {"ID", "Nombre Producto", "Cantidad recibida", "Fecha y Hora"};
        this.salidaProductos = new DefaultTableModel(columnas, 0) {
            @Override
        ...
        this.tbProductos.setModel(this.salidaProductos);
    ...
    private void llenarTabla() {
        ...
        try {
            List<DatosReporteSalidaDTO> listaResultados = control.listarHistorialSalidas(inicioPeriodo, finalPeriodo);
            salidaProductos.setRowCount(0);
            ...
            for (DatosReporteSalidaDTO datos: listaResultados) {
                Object[] fila = new Object[5];
                fila[0] = datos.getId();
                fila[1] = datos.getNombre();
                fila[2] = datos.getCantidad();
                fila[3] = (datos.getFechaHoraOperacion() != null) ? datos.getFechaHoraOperacion().format(dtf) : "";
                salidaProductos.addRow(fila);
            }
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(jDateFinal, javax.swing.GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE)
    ...
    private void btnExportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportarActionPerformed
        ...
        try {
            ...
            for (DatosReporteSalidaDTO datos: listaResultados) {
                ...
                fila[1] = datos.getNombre();
                fila[2] = datos.getCantidad();
                fila[3] = datos.getFechaFormato();
                salidaProductos.addRow(fila);
            }

            JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(listaResultados);
            InputStream reporte = getClass().getClassLoader().getResourceAsStream("reportes/HistorialDeSalidas.jasper");
